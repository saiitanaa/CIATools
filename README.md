...
**13-21 December 2025 | `CIATools`** -- Written in C# WinForms (only for Windows). Slow but stable (v1.0 -> v5) | [Original Branch](https://github.com/saiitanaa/CIATools/tree/winforms)

**29 May to 6 September 2026 | `CIAToolsR`** -- Written in C# (Windows, Linux, macOS). Fast but an interface that's too cluttered is less stable (v6-R -> v10.1.0) | [Original Branch](https://github.com/saiitanaa/CIATools/tree/ciatoolsr)
