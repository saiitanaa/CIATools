    ...
    public partial class MainWindowViewModel : ViewModelBase
    {
        ...
        public void ClearUserFiles()
        {
            try
            {
                ...
                // Correction ici : Utilise explorer.exe pour Windows de façon explicite
                if (Current_os == "Win")
                {
        ...
        [RelayCommand]
        public void PyDependencies()
        {
            Debug_output = "Dependencies check: Python native modules ready.";
        }
    }
}